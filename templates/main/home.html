...
<head>
  ...
  <title>Lonyo - Microfinance and Digital Banking php Template</title>
  ...
  <div class="lonyo-menu-wrapper">
    <div class="lonyo-menu-area text-center">
          ...
          <li class="menu-item-has-children">
            ...
            <ul class="sub-menu">
              ...
              <li class="menu-item-has-children">
                ...
                <ul class="sub-menu">
                  <li><a href="integration.php">Integratios</a></li>
                  <li><a href="single-integration.php">Integratios Details</a></li>
                </ul>
              </li>
              <li class="menu-item-has-children">
              ...
              <li class="menu-item-has-children">
                ...
                <ul class="sub-menu">
                  ...
                  <li><a href="single-career.php">Career details</a></li>
                </ul>
              </li>
              <li class="menu-item-has-children">
                ...
                <ul class="sub-menu">
                  ...
                  <li><a href="404.php">errors 404</a></li>
                  <li><a href="comming-soon.php">Cooming Soon</a></li>
                </ul>
              </li>
              <li class="menu-item-has-children">
      ...
      <div class="lonyo-mobile-menu-btn">
        <a class="lonyo-default-btn sm-size" href="contact.php" data-text="Get in Touch"><span class="btn-wraper">Get in Touch</span></a>
        <a class="lonyo-default-btn sm-size" href="contact.php" data-text="Get in Touch"><span class="btn-wraper">Get in Touch</span></a>
      </div>
    </div>
  </div>
  ...
  <!-- nav end -->        </div>
        <div class="col-auto d-flex align-items-center">
          <div class="lonyo-header-info-wraper2">
            ...
            <a class="lonyo-default-btn lonyo-header-btn" href="contact.php">Book a demo</a>
          </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-7 d-flex align-items-center">
                ...
                <div class="mt-50" data-aos="fade-up" data-aos-duration="900">
                    <a href="sign-up.php" class="lonyo-default-btn hero-btn">Create a free account</a>
                </div>
                </div>
            </div>
            <div class="col-lg-5">
...
<div class="lonyo-section-padding2 position-relative">
  ...
  <!-- end service content -->          <!-- end service content -->
                ...
                <div class="col-lg-7 d-flex align-items-center">
                  <div class="lonyo-default-content lonyo-video-section pl-50" data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div class="mt-50" data-aos="fade-up" data-aos-duration="700">
                      <a class="lonyo-default-btn video-btn" href="contact.php">Download the app</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section class="lonyo-section-padding2 position-relative">
            <div class="container">
              ...
              <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="lonyo-t-wrapper2">
                    <div class="lonyo-t-wrap marquree-top light-bg">
                      <div class="lonyo-t-text">
                        <p>“This app has completely transformed how I manage my money. I can track all my expenses and set up savings goals easily. It’s like having a personal finance manager in my pocket!”</p>
                      </div>
                    ...
                    <div class="lonyo-t-wrap marquree-top light-bg">
                      <div class="lonyo-t-text">
                        <p>"This app transformed my budgeting! I now have a clear view of my expenses and savings goals."</p>
                      </div>
                      <div class="lonyo-t-author">
                        <div class="lonyo-t-author-thumb">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="lonyo-t-wrapper2">
                    <div class="lonyo-t-wrap light-bg marqueeBottom">
                      <div class="lonyo-t-text">
                    ...
                    <div class="lonyo-t-wrap light-bg marqueeBottom">
                      <div class="lonyo-t-text">
                        <p>“I use it for my business accounting, expenses, and tax prep are all so easier. It saves me time and stress.”</p>
                      </div>
                      <div class="lonyo-t-author">
                        <div class="lonyo-t-author-thumb">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="lonyo-t-wrapper2">
                    <div class="lonyo-t-wrap light-bg marquree-top">
                      <div class="lonyo-t-text">
                        <p>“With this app, I’ve been able to stick to my budget and even save for a vacation. The goal-setting feature is super motivating! The budget alerts are a game changer!”</p>
                      </div>
                      <div class="lonyo-t-author">
                        <div class="lonyo-t-author-thumb">
                    ...
                    <div class="lonyo-t-wrap light-bg marquree-top">
                      <div class="lonyo-t-text">
                        <p>"I love how easy it is to track my spending. The real-time updates keep me on top of my finances."</p>
                      </div>
                      <div class="lonyo-t-author">
                        <div class="lonyo-t-author-thumb">
                          <img src="assets/images/v1/img1.png" alt="">
...
<div class="lonyo-section-padding4">
    <div class="container">
      ...
      <div class="faq-btn" data-aos="fade-up" data-aos-duration="700">
        <a class="lonyo-default-btn faq-btn2" href="faq.php">Can't find your answer</a>
      </div>
    </div>
  </div>
...
<div class="lonyo-content-shape">
  ...
  <footer class="lonyo-footer-section light-bg">
    <div class="container">
              ...
              <div class="lonyo-footer-menu-wrap">
                ...
                <div class="lonyo-footer-menu1">
                  <ul>
                    ...
                    <li>
                      <a href="integration.php">Integrations</a>
                    </li>
                    <li>
                      <a href="single-integration.php">Integration single</a>
                    </li>
                    <li>
          ...
          <div class="col-xxl-2 col-xl-4 col-md-6">
            <div class="lonyo-footer-menu pl-30">
              ...
              <ul>
                ...
                <li>
                  <a href="404.php">404 Not found</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="lonyo-footer-bottom-text">
        <p>© Copyright 2025 All Rights Reserved by <b>Template Hunt</b></p>
      </div>
    </div>
  </footer>
  <!-- footer end -->
  ...
  <script src="assets/js/menu/menu.js" defer></script>
  <script src="assets/js/jquery.magnific-popup.min.js" defer></script>
  <script src="assets/js/slick.js" defer></script>
  <script src="assets/js/pricing.min.js" defer></script>
  <script src="assets/js/countdown.js" defer></script>
  <script src="assets/js/skillbar.js" defer></script>
  <script src="assets/js/slick-animation.js" defer></script>
  <script src="assets/js/slick-animation.min.js" defer></script>
  <script src="assets/js/faq.js" defer></script>
  <script src="assets/js/isotope.pkgd.min.js" defer></script>
  <script src="assets/js/tabs-slider.js" defer></script>
  <script src="assets/js/product-increment.js" defer></script>
  <script src="assets/js/aos.js" defer></script>
  <script src="assets/js/niceselect.js" defer></script>
  ...
  <script src="assets/js/app.js" defer></script>
    ...
    <!-- use this for better speed and performance -->
    </body>
</html>

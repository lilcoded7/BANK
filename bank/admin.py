...
class AccountAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Details", {"fields": ("account_number", "date_opened", "is_interoperable")}),
    )
...
class InvestmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("account", "package", "amount", "status")}),
        ("Dates", {"fields": ("start_date", "end_date")}),
        ("Returns", {"fields": ("expected_return", "actual_return")}),
    )
...
class TradePositionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Status", {"fields": ("status", "profit_loss", "opened_at", "closed_at")}),
    )
...
class TransactionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Accounts", {"fields": ("account", "sender_account", "recipient_account")}),
        ("Metadata", {"fields": ("description", "metadata", "timestamp")}),
        ("Related Objects", {"fields": ("investment", "trade_position")}),
    )
...
class SecurityLogAdmin(admin.ModelAdmin):
    ...
    date_hierarchy = "timestamp"
    fieldsets = (
        (None, {"fields": ("user", "event_type", "ip_address")}),
        ("Details", {"fields": ("device_info", "details", "timestamp")}),
    )
...
class FingerPrintAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("user",)}),
        ("Biometric Data", {"fields": ("template_data", "image")}),
